...
def smoltalk2_preference(example: dict[str, Any]) -> dict[str, Any]:
    ...
    Uses the 'chosen' column as the messages.
    """
...
def helpsteer3_feedback(example: dict[str, Any]) -> dict[str, Any]:
    ...
    Picks the response with the higher score.
    """
    grades = {
        "not": 0,
        "slightly": 1,
...
def helpsteer3_edit(example: dict[str, Any]) -> dict[str, Any]:
    ...
    Uses the 'context' and 'edited_response' columns.
    """
    return {
        "messages": [
            *example["context"],
...
def helpsteer3_edit_quality(example: dict[str, Any]) -> dict[str, Any]:
    ...
    Uses the 'context' and 'good_edited_response' columns.
    """
    return {
        "messages": [
            *example["context"],
